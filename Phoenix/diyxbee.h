...
#define XBEE_REQ_SN_NI              0x06          // Request the serial number and NI string
                                                  ...
                                                  // We transmite a bit mask with which fields changed plus the bytes that changes
#define XBEE_TRANS_CHANGED_DATA                 0x07

                                                  //
#define XBEE_TRANS_NOTHIN_CHANGED               0x08
                                                  //  What format of data this transmitter supports.
#define XBEE_TRANS_DATA_VERSION                 0x09
// 1- New format supports changed data packets...
                                                  // Debug Attach - used to say send debug info to display
#define XBEE_DEBUG_ATTACH                       0x0A
                                                  // End debug output messages...
#define XBEE_DEBUG_DETACH                       0x0B
                                                  // Debug Text sent from Debug App...
#define XBEE_DEBUG_STRING                       0x0C
...
#define XBEE_RECV_DISP_VAL2             0x8B      // Display a value on line 2  - Cal
                                                  ...
                                                  // New format...
#define XBEE_RECV_REQ_DATA2                     0x90
...
#define XBeeOutputStringF XBeeOutputString        // BUGBUG:: probably conditional.
...
extern WrapperSerial XBeeSerial;
#endif
#endif                                            // _DIYXBEE_H_
