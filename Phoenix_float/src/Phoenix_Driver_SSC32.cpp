...
//------------------------------------------------------------------------------------------
#define SERVO_TIC_PER_DEG       10.102
#define SERVO_CENTER_VALUE      1500    // half of our 1024 range
...
#endif
{
    ...
    wCoxaSSCV = CoxaAngle * SERVO_TIC_PER_DEG + SERVO_CENTER_VALUE;
    wFemurSSCV = FemurAngle * SERVO_TIC_PER_DEG + SERVO_CENTER_VALUE;
    wTibiaSSCV = TibiaAngle * SERVO_TIC_PER_DEG + SERVO_CENTER_VALUE;
#ifdef c4DOF
    wTarsSSCV = TarsAngle * SERVO_TIC_PER_DEG + SERVO_CENTER_VALUE;
#endif
